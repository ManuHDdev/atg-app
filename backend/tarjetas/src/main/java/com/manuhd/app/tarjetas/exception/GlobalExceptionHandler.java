...
public class GlobalExceptionHandler {
     ...
     *
     * <p>Los mensajes de la aplicación están escritos en español y para el usuario de oficina
     * ("Solicitud no encontrada con id: 3", "El motivo del duplicado es obligatorio"), así que
     * se devuelven tal cual. Los del framework no: en producción se llegó a enseñar en el
     * navegador el texto en inglés de {@code UnexpectedRollbackException}, "Transaction silently
     * rolled back because it has been marked as rollback-only", que al usuario no le dice nada
     * y además destapa detalles internos.
     */
